...
class ServiceInstanceCollectionTestCase(TestCase):
    ...
    def setup_collection(self):
        ...
        self.config = Turtle()
        context     = Turtle()
        self.collection = service.ServiceInstanceCollection(
    ...
    def test_clear_failed(self):
        instances = [
            Turtle(state=service.ServiceInstance.STATE_FAILED),
            Turtle(state=service.ServiceInstance.STATE_UP),
        ]
    ...
    def test_clear_failed_none(self):
        instances = [Turtle(state=service.ServiceInstance.STATE_UP)]
        self.collection.instances.extend(instances)
        self.collection.clear_failed()
    ...
    def test_get_up_none(self):
        instances = [
            Turtle(state=service.ServiceInstance.STATE_DOWN),
            Turtle(state=service.ServiceInstance.STATE_FAILED)
        ]
        self.collection.instances.extend(instances)
        up_instances = list(self.collection.get_up())
    ...
    def test_create_missing(self):
        ...
        assert_equal(created, self.collection.instances)
