...
class TestTimeDelta(TestCase):
    ...
    def check_delta(self, start, target, years=0, months=0, days=0):
        assert_equal(
            start + macro_timedelta(start, years=years, months=months, days=days,), target,
        )
    ...
    def test_days(self):
        ...
        self.check_delta(
            self.begin_feb_nonleap, datetime.datetime(year=2011, month=3, day=1), days=28,
        )
        self.check_delta(
    ...
    def test_months(self):
        self.check_delta(
            self.start_nonleap, datetime.datetime(year=2011, month=11, day=1), months=10,
        )
        self.check_delta(
        ...
        self.check_delta(
            self.begin_feb_nonleap, datetime.datetime(year=2011, month=12, day=1), months=10,
        )
        self.check_delta(
            self.begin_feb_leap, datetime.datetime(year=2012, month=12, day=1), months=10,
        )
    ...
    def test_years(self):
        ...
        self.check_delta(
            self.begin_feb_nonleap, datetime.datetime(year=2015, month=2, day=1), years=4,
        )
        self.check_delta(
    ...
    def test_start_date_with_timezone(self):
        ...
        start_date = pacific_tz.localize(datetime.datetime(year=2018, month=1, day=3, hour=13),)
        expected_end = pacific_tz.localize(datetime.datetime(year=2018, month=1, day=1, hour=13),)
        self.check_delta(
