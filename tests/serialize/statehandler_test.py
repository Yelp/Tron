...
from testify import suite, assert_equal, assert_raises, turtle
import yaml
...
from tron.serialize import statehandler
from tron.utils import timeutils
from tron import event, mcp, node, scheduler, service
...
"""
    ...
    def test(self):
        ...
        assert_raises(statehandler.UnsupportedVersionError,
                handler._load_data_file, self.data_file)
...
"""
    ...
    def test(self):
        handler = mcp.StateHandler(turtle.Turtle(), "/tmp")
        assert_raises(statehandler.StateFileVersionError,
                handler._load_data_file, self.data_file)