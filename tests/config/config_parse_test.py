...
class ConfigContainerTestCase(TestCase):
    ...
    def setup_container(self):
        master_config = valid_config(yaml.load(BASE_CONFIG))
        config = {MASTER_NAMESPACE: master_config}
        self.container = config_parse.ConfigContainer(config)
