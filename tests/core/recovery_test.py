...
class TestRecovery(TestCase):
    ...
    def test_filter_recovery_candidates(self):
        with mock.patch('tron.core.recovery.group_by_actionrun_type', autospec=True) as mock_group_by_type, \
            ...
            mock_group_by_type.assert_called_once_with(
                action_runs=['foo']
            )
